...

{
    ...
    // 4. setAge에서 100살을 초과하여 입력할 경우, "나이는 100살을 초과할 수 없습니다." 를 출력하고, 
    //      age가 재설정되지 않도록 setAge를 수정해주세요.
    // 5. new를 이용해 User객체에 "본인이름", "본인나이"를 대입한 변수 user1을 만들고, 
    //      getAge를 이용하여 본인 나이를 출력해보고, setAge를 이용해 150살을 입력했을때 결과를 확인하세요~!
    //      코드를 여기에 작성하세요.
    class User{
        #name;
        #age;
...

{
    ...
    console.log(exam.hasOwnProperty('total')); // false
    console.log(exam.__proto__.hasOwnProperty('total')); // true
    console.log(exam2.hasOwnProperty('total')); // false
    console.log(exam2.__proto__.hasOwnProperty('total')); // true
...

{
    ...
    let exam1 = new Exam(10,10,10);
    let exam2 = new NewExam(10,10,10,10);
    console.log(exam1.total());
    console.log(exam1.avg());
    console.log(exam2.total());
    console.log(exam2.avg());
